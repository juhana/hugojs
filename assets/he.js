...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 36960,
    DYNAMIC_BASE = 5279840,
    DYNAMICTOP_PTR = 36944;
...
var ASM_CONSTS = {
  1320: function($0) {hugoui.filePrompt(AsciiToString($0));},  
 1646: function() {hugoui.waitKeypress();},  
 1922: function() {return haven.input.keypress.isWaiting();},  
 1967: function() {hugoui.initScreen();},  
 1988: function($0) {hugoui.setTitle(AsciiToString($0));},  
 2028: function() {hugoui.gameEnded();},  
 2048: function() {hugoui.clear();},  
 2064: function($0) {hugoui.clear($0);},  
 2086: function() {hugoui.sendWindowDimensions();},  
 2117: function($0, $1, $2, $3, $4) {haven.window.create($0, $1, $2, $3, $4);},  
 2162: function($0, $1, $2) {hugoui.position.set($0, $1, $2);},  
 2199: function($0, $1) {hugoui.print(AsciiToString($0), $1);},  
 2240: function($0, $1) {hugoui.font.set($0, $1);},  
 2269: function($0, $1) {hugoui.color.set( 'text', $0, $1 );},  
 2309: function($0, $1) {hugoui.color.set( 'background', $0, $1 );},  
 2359: function() {haven.file.syncfs();},  
 2384: function() {hugoui.restoreUI();},  
 2726: function() {if( hugoui.opcodes ) { hugoui.opcodes.process(); }},  
 3733: function() {haven.state.autosave.remove();}
};
function haven_getkey(){ return Asyncify.handleAsync(async () => { const key = await hugoui.waitKeypressPromise(); switch( key ) { case 0: return 13; case 37: return 8; case 38: return 11; case 39: return 21; case 40: return 10; default: return key; } }); }
function haven_getline(){ return Asyncify.handleAsync(async () => { const s = await hugoui.waitLine(); const lengthBytes = lengthBytesUTF8(s)+1; const stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(s, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; }); }



// STATICTOP = STATIC_BASE + 35936;
...
var asmLibraryArg = { "__localtime_r": ___localtime_r, "__sys_fcntl64": ___sys_fcntl64, "__sys_ioctl": ___sys_ioctl, "__sys_open": ___sys_open, "emscripten_asm_const_int": _emscripten_asm_const_int, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_sleep": _emscripten_sleep, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "haven_getkey": haven_getkey, "haven_getline": haven_getline, "memory": wasmMemory, "setTempRet0": _setTempRet0, "strftime": _strftime, "table": wasmTable, "time": _time };
...
/** @type {function(...*):?} */
var _haven_start = Module["_haven_start"] = createExportWrapper("haven_start");
...
/** @type {function(...*):?} */
var _hugo_set_window_dimensions = Module["_hugo_set_window_dimensions"] = createExportWrapper("hugo_set_window_dimensions");

/** @type {function(...*):?} */
var _haven_save_autosave = Module["_haven_save_autosave"] = createExportWrapper("haven_save_autosave");

/** @type {function(...*):?} */
var _hugojs_set_autosave_filename = Module["_hugojs_set_autosave_filename"] = createExportWrapper("hugojs_set_autosave_filename");

/** @type {function(...*):?} */
var _hugojs_set_font = Module["_hugojs_set_font"] = createExportWrapper("hugojs_set_font");

/** @type {function(...*):?} */
var _hugojs_set_colors = Module["_hugojs_set_colors"] = createExportWrapper("hugojs_set_colors");

/** @type {function(...*):?} */
var _hugojs_get_dictionary_word = Module["_hugojs_get_dictionary_word"] = createExportWrapper("hugojs_get_dictionary_word");
