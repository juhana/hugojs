...
#define PORT_NAME "Emscripten"
#define PORTER_NAME "Juhana Leinonen"

#define PROMPTMORE_REPLACED
#define NO_TERMINAL_LINEFEED
#define EXTRA_STRING_FUNCTIONS
#define NO_STDIO_WINDOWS
#define FRONT_END
...
#define DEF_PRN         "/dev/lp"

#define DEF_FCOLOR      7   // white
#define DEF_BGCOLOR     0   // black
#define DEF_SLFCOLOR	15  // bright white
#define DEF_SLBGCOLOR	1   // blue

#define MAXBUFFER 1280

int hugojs_get_linelength(void);
#define ACTUAL_LINELENGTH() hugojs_get_linelength()
int hugojs_get_screenheight(void);
#define ACTUAL_SCREENHEIGHT() hugojs_get_screenheight()

#define HUGO_INLINE static inline
#define OPCODE_CONTROL_FILE "./HrCtlAPI"
...
#endif
void hugo_set_window_width(int width);
